...
const CARD_TRADE_NFT_PRICE_DEFAULT_DENOMINATION = BigNumber(
  process.env.CARD_TRADE_NFT_PRICE_DEFAULT_DENOMINATION as string
);
export const CARD_PACK_PRICE = CARD_TRADE_NFT_PRICE_DEFAULT_DENOMINATION.times(
